...
async def not_chat(_, m: Message):
    if m.from_user is not None and m.from_user.id in Config.SUDO:
        ...
        buttons = [
            [
                InlineKeyboardButton('⚡️Bot Owner', url='https://github.com/subinps/VCPlayerBot'),
                InlineKeyboardButton('🧩 Join Here', url='https://t.me/xxdarklovexx'),
            ]
            ]
        await m.reply("<b>You can't use this bot in this group, ADL DRAMA TEAM CREATE BOT [OWNER](https://t.me/XxDarkLovexX) below.</b>", disable_web_page_preview=True, reply_markup=InlineKeyboardMarkup(buttons))
